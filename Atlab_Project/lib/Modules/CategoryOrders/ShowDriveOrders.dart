...
class ShowDriveOrder extends StatelessWidget {
        ...
        builder: (context) {
          ...
          return BlocConsumer<AppCubit,AppStates>(
              ...
              builder: (context,state){
                var order = AppCubit.get(context).driveList;
                      ...
                      builder:(context)=> Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('توصيل طلبات',style: TextStyle(
                                color: Colors.black,
                                fontSize: 17,
                                fontWeight: FontWeight.bold,
                                fontFamily: 'Lemonada'
...
Widget clientItem (DriveModel model , context,List<Color> colors,index)
{
            ...
            child:  Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text('التوصيل من : ',style: TextStyle(
                          fontSize: 19,
                          fontWeight: FontWeight.bold
                      )),
                      Text(model.from!,style: TextStyle(
                        fontSize: 17,
                      ))
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text('التوصيل الي : ',style: TextStyle(
                          fontSize: 19,
                          fontWeight: FontWeight.bold
                      )),
                      Text(model.to!,style: TextStyle(
                        fontSize: 17,
                      ))
                    ],
                  ),
                ...
                Row(
                  children: [
                    ...
                    IconButton(onPressed: (){
                      print('Hi');
                      AppCubit.get(context).deleteDriveOrder(index);
